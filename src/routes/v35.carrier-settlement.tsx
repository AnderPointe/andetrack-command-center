...
import { SETTLEMENTS } from "@/v35/data/mockPhase20";
...
export const Route = createFileRoute("/v35/carrier-settlement")({
  ...
  component: () => (
    <V35Page icon={<Wallet className="size-6 text-amber-300" />} title="Carrier Settlement (placeholder)"
      blurb="Settlement workflow shell: POD-bound, approval-gated, and payment status placeholder. No real payouts are issued.">
